...
SSH.prototype._queueCommand = function(index) {
    ...
    // Skip command if not connected at the time of executing it
    if (!(this._c._sock &&
            this._c._sock.writable &&
            this._c._sock._readableState &&
            this._c._sock._readableState.ended === false)) {
        command.handlers.err(new Error('Not connected'));
        return;
    }
